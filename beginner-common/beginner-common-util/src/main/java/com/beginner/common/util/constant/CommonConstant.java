package com.beginner.common.util.constant;
/**
 * @Description: 通用常量
 */
public class CommonConstant {
    ...
    public static final Integer SC_OK_204 = 204;
     ...
     * 登录用户Shiro权限缓存KEY前缀
     */
    public static String PREFIX_USER_SHIRO_CACHE = "shiro:cache:org.ch.config.shiro.ShiroRealm.authorizationCache:";
    /**
     * 登录用户Token令牌缓存KEY前缀
     */
